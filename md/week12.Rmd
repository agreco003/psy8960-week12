...
# Final Analysis: Topic predicting Upvotes
final_week12_tbl <- mutate(week12_tbl, doc_id = as.numeric(row.names(week12_tbl))) #added rownames for doc_id matching in multiple tibbles
final_tbl <- full_join(final_week12_tbl, topics_tbl, by = "doc_id") %>% #retains all case numbers, even missing values
